...
HD_PWD='/home/barsievich/fpga_lab06/fpga_lab06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_of_quadrats.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_of_quadrats.tcl
