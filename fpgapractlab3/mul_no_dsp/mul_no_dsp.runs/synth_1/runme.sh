...
HD_PWD='/home/victor/Documents/ComputerResearch/fpga_pract/mul_no_dsp/mul_no_dsp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_dsp_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_dsp_wrapper.tcl
