...
HD_PWD='/home/victor/Documents/ComputerResearch/fpga_pract/dsp_simd/dsp_simd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_simd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_simd.tcl
