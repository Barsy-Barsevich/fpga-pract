...
HD_PWD='/home/victor/Documents/ComputerResearch/fpga_pract/dsp_preadd/dsp_preadd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_preadd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_preadd.tcl
