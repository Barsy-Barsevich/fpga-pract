...
HD_PWD='/home/barsievich/fpga_lab05/fpga_lab05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log syst_ws.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source syst_ws.tcl
