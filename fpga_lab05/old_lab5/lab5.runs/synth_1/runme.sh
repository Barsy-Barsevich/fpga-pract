...
HD_PWD='/home/victor/Documents/ComputerResearch/fpga_pract/lab5/lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pow5_pipelined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pow5_pipelined.tcl
