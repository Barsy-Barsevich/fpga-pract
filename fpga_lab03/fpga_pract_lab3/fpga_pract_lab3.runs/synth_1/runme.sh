...
HD_PWD='/home/victor/Documents/ComputerResearch/fpga_pract/fpga_pract_lab3/fpga_pract_lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_dsp_async.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_dsp_async.tcl
