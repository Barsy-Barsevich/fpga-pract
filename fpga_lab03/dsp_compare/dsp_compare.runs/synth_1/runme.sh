...
HD_PWD='/home/victor/Documents/ComputerResearch/fpga_pract/dsp_compare/dsp_compare.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_compare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_compare.tcl
