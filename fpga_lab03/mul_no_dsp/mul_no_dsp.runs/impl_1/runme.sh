...
HD_PWD='/home/victor/Documents/ComputerResearch/fpga_pract/mul_no_dsp/mul_no_dsp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_dsp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_dsp_wrapper.tcl -notrace
